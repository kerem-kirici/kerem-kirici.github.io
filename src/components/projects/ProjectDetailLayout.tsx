  ...
  return (
    <section className="py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-12 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
          <div className="space-y-10">
            <header className="space-y-5">
              <Heading as="h1" size="xl" weight="semibold" tracking="tight">
                {project.title}
              </Heading>
              <Text size="lg" leading="relaxed" tone="muted" className="max-w-3xl">
                {project.description}
              </Text>
          ...
          <aside className="h-max space-y-6 rounded-3xl border border-black/10 bg-white/80 p-6 shadow-lg backdrop-blur-sm dark:border-white/10 dark:bg-zinc-900/70">
              ...
              <div>
                ...
                <div className="mt-2 space-y-2 text-sm text-zinc-600 dark:text-zinc-300">
                  ...
                  <code className="block truncate rounded-lg bg-zinc-100 px-3 py-2 text-xs font-medium text-zinc-700 dark:bg-zinc-800 dark:text-zinc-200">
                    {
                      `https://${process.env.NEXT_PUBLIC_DOMAIN}${project.href}` // change to the actual domain
                    }
                  </code>
                </div>
              </div>
