const TEXT_DICTIONARY = {
  ...
  'projects.sudokumobileapp.long_explanation': {
    ...
    tr: "React Native ve Expo ile modern bir kullanıcı deneyimi için tasarlanmış kapsamlı, platformlar arası bir Sudoku uygulaması. Çoklu zorluk seviyeleri (Kolay'dan Uzman'a), akıllı not alma, gerçek zamanlı otomatik doğrulama ve tam bir geri alma/yineleme sistemi ile tam özellikli bir deneyim sunar. Uygulama, gradyanlı güzel bir karanlık temaya, Reanimated ile akıcı animasyonlara ve dokunsal geri bildirime sahiptir. Teknik olarak, TypeScript ile yazılmış, navigasyon için Expo Router kullanmakta ve 60fps, duyarlı bir deneyim sağlamak için çevrimdışı oyun ve ilerleme kaydı için Async Storage'dan yararlanmaktadır.",
  },
  'projects.sudokumobileapp.tags': {
    en: 'React Native, Expo, TypeScript',
    tr: 'React Native, Expo, TypeScript',
  },

  // --- Project: Pokerist ---
  'projects.pokerist.title': {
    en: 'Pokerist',
    tr: 'Pokerist',
  },
